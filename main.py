...
openai.api_key = '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'
...
def authorization_setup(testflow=None):
    # OAuth 2.0 Setup
    scopes = ['https://www.googleapis.com/auth/calendar']
    flow = testflow.from_client_secrets_file("cred.json", scopes=scopes)
